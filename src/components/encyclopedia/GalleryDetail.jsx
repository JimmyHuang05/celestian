...
function GalleryDetail({ node, isMobile, onClose, supabaseClient }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center pointer-events-none" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Serif SC', sans-serif" }}>
      ...
      <div className={`relative flex flex-col pointer-events-auto z-10 shadow-[0_0_80px_rgba(0,0,0,0.8)] overflow-hidden bg-[#050505] ${isMobile ? 'w-full h-[100dvh] rounded-none' : 'w-11/12 md:w-10/12 max-w-5xl h-[80vh] md:h-[75vh] rounded-xl border border-white/10'}`}>
